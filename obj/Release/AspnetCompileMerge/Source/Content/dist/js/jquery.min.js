...
$('.search-button').click(function () { $('body').toggleClass('open-search'); });
$('.hamburger').click(function () { $('body').removeClass('open-search'); });
$('.search-button').click(function () { $('body').removeClass('open-menu'); });
$('.single .blocks-gallery-item a').attr('data-fancybox', 'gallery');
...
})(jQuery); $('.marquee').marquee({ duration: 50000, pauseOnHover: true, duplicated: true, gap: 0, startVisible: true });

//Accordion
$(function () { if ($(window).width() < 960) { var t = function (t, e) { this.el = t || {}, this.multiple = e || !1, this.el.find(".accordion-click").on("click", { el: this.el, multiple: this.multiple }, this.dropdown) }; t.prototype.dropdown = function (t) { var e = t.data.el; $this = $(this), $next = $this.next(), $next.slideToggle(), $this.parent().toggleClass("open"), t.data.multiple || e.find(".accordion-content").not($next).slideUp().parent().removeClass("open") }; new t($(".footer-menu"), !1) } });

// Slider
jQuery(document).ready(function (t) { !function (n, s) { var i = "#" + n.attr("id"), l = n.find("ul li").length; slideWidth = n.attr("data-width"); var e, a, r, o, d = (l + 1) * slideWidth, c = 2; function u() { e.css({ width: "0%" }), clearTimeout(r), o = 0, r = setInterval(f, s) } function f() { !1 === a && (o += 1 / (c + .1), e.css({ width: o + "%" }), o >= 100 && (v(), u())) } a = !1, e = n.find(".progress .bar"), l > 1 ? (t(i + " ul li:last-child").prependTo(i + " ul"), n.find("ul").css({ width: d + "vw", marginLeft: -slideWidth + "vw" }), n.find("ul li:last-child").appendTo(n.attr("id") + " ul"), u()) : (t(i + " button.control_prev").hide(), t(i + " button.control_next").hide()); function v() { l > 2 ? (t(i + " ul").css({ transition: "1s", transform: "translateX(" + -1 * slideWidth + "vw)" }), setTimeout(function () { t(i + " ul li:first-child").appendTo(i + " ul"), t(i + " ul").css({ transition: "none", transform: "translateX(0vw)" }), t("li.actslide").next().addClass("actslide").prev().removeClass("actslide") }, 1e3)) : (t(i + " ul li:first-child").appendTo(i + " ul"), t(i + " ul").css({ transition: "none", transform: "translateX(100vw)" }).delay(), setTimeout(function () { t(i + " ul").css({ transition: "1s", transform: "translateX(0vw)" }) }, 100, setTimeout(function () { t(i + " ul").css({ transition: "none", transform: "translateX(0vw)" }), t("li.actslide").next().addClass("actslide").prev().removeClass("actslide") }, 1e3))) } t(i + " button.control_prev").click(function () { t(i + " ul").css({ transition: "1s", transform: "translateX(" + slideWidth + "vw)" }), setTimeout(function () { t(i + " ul li:last-child").prependTo(i + " ul"), t(i + " ul").css({ transition: "none", transform: "translateX(0vw)" }), t("li.actslide").prev().addClass("actslide").next().removeClass("actslide") }, 1e3), u() }), t(i + " button.control_next").click(function () { v(), u() }), t(i + " .progress").click(function () { a = !1 === a }) }(t("#sliderglb"), 30) });

jQuery(document).ready(function (t) { !function (n, s) { var i = "#" + n.attr("id"), l = n.find("ul li").length; slideWidth = n.attr("data-width"); var e, a, r, o, d = (l + 1) * slideWidth, c = 2; function u() { e.css({ width: "0%" }), clearTimeout(r), o = 0, r = setInterval(f, s) } function f() { !1 === a && (o += 1 / (c + .1), e.css({ width: o + "%" }), o >= 100 && (v(), u())) } a = !1, e = n.find(".progress .bar"), l > 1 ? (t(i + " ul li:last-child").prependTo(i + " ul"), n.find("ul").css({ width: d + "vw", marginLeft: -slideWidth + "vw" }), n.find("ul li:last-child").appendTo(n.attr("id") + " ul"), u()) : (t(i + " button.control_prev").hide(), t(i + " button.control_next").hide()); function v() { l > 2 ? (t(i + " ul").css({ transition: "1s", transform: "translateX(" + -1 * slideWidth + "vw)" }), setTimeout(function () { t(i + " ul li:first-child").appendTo(i + " ul"), t(i + " ul").css({ transition: "none", transform: "translateX(0vw)" }), t("li.actslide").next().addClass("actslide").prev().removeClass("actslide") }, 1e3)) : (t(i + " ul li:first-child").appendTo(i + " ul"), t(i + " ul").css({ transition: "none", transform: "translateX(100vw)" }).delay(), setTimeout(function () { t(i + " ul").css({ transition: "1s", transform: "translateX(0vw)" }) }, 100, setTimeout(function () { t(i + " ul").css({ transition: "none", transform: "translateX(0vw)" }), t("li.actslide").next().addClass("actslide").prev().removeClass("actslide") }, 1e3))) } t(i + " button.control_prev").click(function () { t(i + " ul").css({ transition: "1s", transform: "translateX(" + slideWidth + "vw)" }), setTimeout(function () { t(i + " ul li:last-child").prependTo(i + " ul"), t(i + " ul").css({ transition: "none", transform: "translateX(0vw)" }), t("li.actslide").prev().addClass("actslide").next().removeClass("actslide") }, 1e3), u() }), t(i + " button.control_next").click(function () { v(), u() }), t(i + " .progress").click(function () { a = !1 === a }) }(t("#slideratl"), 30) });

//Filter
!function () { function e(e) { this.element = e } var t = function (e) { return RegExp("(^| )" + e + "( |$)") }, n = function (e, t, n) { for (var s = 0; s < e.length; s++)t.call(n, e[s]) }; e.prototype = { add: function () { n(arguments, function (e) { this.contains(e) || (this.element.className += " " + e) }, this) }, remove: function () { n(arguments, function (e) { this.element.className = this.element.className.replace(t(e), "") }, this) }, toggle: function (e) { return this.contains(e) ? (this.remove(e), !1) : (this.add(e), !0) }, contains: function (e) { return t(e).test(this.element.className) }, replace: function (e, t) { this.remove(e), this.add(t) } }, "classList" in Element.prototype || Object.defineProperty(Element.prototype, "classList", { get: function () { return new e(this) } }), window.DOMTokenList && null == DOMTokenList.prototype.replace && (DOMTokenList.prototype.replace = e.prototype.replace) }(), window.Element && !Element.prototype.closest && (Element.prototype.closest = function (e) { var t, n = (this.document || this.ownerDocument).querySelectorAll(e), s = this; do { for (t = n.length; --t >= 0 && n.item(t) !== s;); } while (t < 0 && (s = s.parentElement)); return s }); var activeClass = "is-active", forEach = function (e, t, n) { for (var s = 0; s < e.length; s++)t.call(n, s, e[s]) }; forEach(document.querySelectorAll(".dropdown_list span.dropdown"), function (e, t) { t.addEventListener("click", function () { if (t.classList.contains(activeClass)) t.classList.contains(activeClass) && t.classList.remove(activeClass); else { var e, n = document.querySelectorAll(".dropdown_list span.dropdown"); for (e = 0; e < n.length; e++)n[e].classList.remove(activeClass); t.classList.toggle(activeClass) } }) }), document.addEventListener("click", function (e) { var t, n = document.querySelectorAll(".dropdown_list span.dropdown"); if (!((e = e || window.event).target ? e.target : e.srcElement).closest(".dropdown_list")) for (t = 0; t < n.length; t++)n[t].classList.remove(activeClass) }, !1);
